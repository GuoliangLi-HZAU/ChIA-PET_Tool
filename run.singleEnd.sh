PROGRAM_DIRECTORY='/home/hdchang/local/ChIA-PET_singleEnd/ChIA-PET_Tool-master/program'
INPUT_INFO_FILE='Hela.input.information.singleEnd.txt'
...
GENOME_INDEX='/home/hdchang/data/genome/human/hg19.genome.fa'

BWA='/home/hdchang/local/bwa-0.7.7/bwa'
NTHREADS='6' ### number of threads used in mapping reads to a reference genome
SAMTOOLS='/home/hdchang/local/samtools-0.1.19/samtools'
BAM2BEDPE='/home/hdchang/local/bedtools-2.17.0/bin/bamToBed -bedpe'
...
####### linker filtering
time=`date '+%s'` 
java -cp ${PROGRAM_DIRECTORY}/LGL.jar LGL.chiapet.LinkerFiltering_FastQ_singleEnd ${INPUT_INFO_FILE} ${OUTPUT_DIRECTORY} ${OUTPUT_PREFIX}
